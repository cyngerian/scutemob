...
pub fn get_tools() -> Vec<ToolDefinition> {
    vec![
        ...
        ToolDefinition {
            ...
            description: "Find all implementations of a trait or type at a specific position"
                .to_string(),
            input_schema: json!({
                "type": "object",
                "properties": {
        ...
        ToolDefinition {
            ...
            description: "Find all callers of a function at a specific position".to_string(),
            input_schema: json!({
                "type": "object",
                "properties": {
                    "file_path": { "type": "string", "description": "Path to the Rust file" },
        ...
        ToolDefinition {
            ...
            description: "Find all functions called by the function at a specific position"
                .to_string(),
            input_schema: json!({
                "type": "object",
                "properties": {
        ...
        ToolDefinition {
            ...
            description: "Search for symbols by name across the entire workspace".to_string(),
            input_schema: json!({
                "type": "object",
                "properties": {
