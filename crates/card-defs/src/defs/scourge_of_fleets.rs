...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "When this creature enters, return each creature your opponents control with \
                      toughness X or less to its owner's hand, where X is the number of Islands \
                      you control."
            .to_string(),
        power: Some(6),
        toughness: Some(6),
