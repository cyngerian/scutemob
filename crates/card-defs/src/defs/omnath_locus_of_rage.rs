...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Landfall \u{2014} Whenever a land you control enters, create a 5/5 red and \
                      green Elemental creature token.\nWhenever Omnath, Locus of Rage or another \
                      Elemental you control dies, Omnath deals 3 damage to any target."
            .to_string(),
        power: Some(5),
        toughness: Some(5),
        abilities: vec![
