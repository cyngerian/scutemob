...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "{T}: Target creature you control gains protection from the color of your \
                      choice until end of turn."
            .to_string(),
        power: Some(1),
        toughness: Some(1),
        ...
        completeness: Completeness::inert(
            "DSL gap — 'color of your choice' requires interactive choice + dynamic \
             ProtectionQuality grant. Only the creature body...",
        ),
    }
}
