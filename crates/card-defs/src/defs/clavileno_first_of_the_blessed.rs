...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Whenever you attack, target attacking Vampire that isn't a Demon becomes a \
                      Demon in addition to its other types. It gains \"When this creature dies, \
        ...
        completeness: Completeness::inert(
            "'Whenever you attack' effect (type change + grant trigger to target) not expressible \
             in DSL. WheneverYouAttack trigger...",
        ),
        ..Default::default()
    }
}
