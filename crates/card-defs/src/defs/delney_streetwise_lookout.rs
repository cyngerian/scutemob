...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Creatures you control with power 2 or less can't be blocked by creatures \
                      with power 3 or greater.\nIf an ability of a creature you control with \
                      power 2 or less triggers, that ability triggers an additional time."
            .to_string(),
        power: Some(2),
        toughness: Some(2),
        abilities: vec![
        ...
        completeness: Completeness::partial(
            "Power-conditional blocking restriction — 'can't be blocked by creatures with power 3 \
             or greater' applies only to your...",
        ),
        ..Default::default()
    }
}
