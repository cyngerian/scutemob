...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Whenever you draw your second card each turn, create a 2/2 blue Drake \
                      creature token with flying.\nWhenever you draw your fifth card each turn, \
        ...
        completeness: Completeness::partial(
            "'Whenever you draw your second card each turn' — requires a per-turn draw-count \
             trigger (fire on Nth draw)....",
        ),
        ..Default::default()
    }
}
