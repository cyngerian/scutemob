...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Return target creature card from your graveyard to your hand.\nRecover \
                      {2}{B} (When a creature is put into your graveyard from the battlefield, \
                      you may pay {2}{B}. If you do, return this card from your graveyard to your \
                      hand. Otherwise, exile this card.)"
            .to_string(),
        abilities: vec![
