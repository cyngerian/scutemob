...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Creatures with power less than this creature's power can't block \
                      it.\nMegamorph {1}{G} (You may cast this card face down as a 2/2 creature \
                      for {3}. Turn it face up any time for its megamorph cost and put a +1/+1 \
                      counter on it.)\nWhen this creature is turned face up, return target card \
        ...
        completeness: Completeness::partial(
            "Static evasion — 'Creatures with power less than this creature's power can't block \
             it.' Needs...",
        ),
        ..Default::default()
    }
