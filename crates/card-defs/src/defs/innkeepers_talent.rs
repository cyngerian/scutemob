...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "At the beginning of combat on your turn, put a +1/+1 counter on target \
                      creature you control.\n{G}: Level 2\nPermanents you control with counters \
                      on them have ward {1}.\n{3}{G}: Level 3\nIf you would put one or more \
                      counters on a permanent or player, put twice that many of each of those \
                      kinds of counters on that permanent or player instead."
            .to_string(),
        abilities: vec![
        ...
        completeness: Completeness::inert(
            "Blocked on Level 2 only: no EffectFilter variant selects 'permanents you control \
             ...
             targeted trigger) and Level 3 (ReplacementModification::DoubleCounters) are both \
             expressible today.",
        ),
        ..Default::default()
    }
