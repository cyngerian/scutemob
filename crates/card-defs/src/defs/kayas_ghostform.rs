    ...
    CardDefinition {
        ...
        completeness: Completeness::partial(
            "Blocked on a trigger keyed to the ENCHANTED permanent's zone change ('dies or is put \
             ...
             WhenDies/WhenLeavesBattlefield key on the Aura itself. NOT blocked: 'Enchant \
             creature or planeswalker' — EnchantTarget::CreatureOrPlaneswalker exists; the def \
             currently declares Enchant(Creature), which wrongly narrows legal targets and drops \
             'you control'.",
        ),
        ..Default::default()
    }
