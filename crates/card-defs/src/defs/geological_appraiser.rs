...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "When this creature enters, if you cast it, discover 3. (Exile cards from \
                      the top of your library until you exile a nonland card with mana value 3 or \
                      less. Cast it without paying its mana cost or put it into your hand. Put \
