...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "This spell can't be countered.\nGreen spells you control can't be \
                      countered.\n{4}{G}{G}: Until end of turn, each Elf creature you control has \
                      base power and toughness 5/5 and becomes a Dinosaur in addition to its \
        ...
        completeness: Completeness::partial(
            "'Green spells you control can't be countered' — static anti-counter effect not in DSL",
        ),
        ..Default::default()
    }
}
