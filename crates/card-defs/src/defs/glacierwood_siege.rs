...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "As Glacierwood Siege enters, choose Temur or Sultai.\n• Temur — Whenever \
                      you cast an instant or sorcery spell, mill four cards.\n• Sultai — You may \
        ...
        completeness: Completeness::partial(
            "As-enters mode choice ('choose Temur or Sultai') is the sole blocker — \
             ...
             today (Temur: WheneverYouCastSpell{instant/sorcery} + MillCards(4); Sultai: \
             AbilityDefinition::StaticPlayFromGraveyard{filter: PlayFromTopFilter::LandsOnly}).",
        ),
        ..Default::default()
    }
}
