...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Flying\nWhenever a player attacks one of your opponents, if that opponent \
                      has more life than another of your opponents, that attacking player draws a \
        ...
        completeness: Completeness::partial(
            "DSL gap — complex multiplayer trigger: 'whenever a player attacks one of your \
             opponents' with life comparison...",
        ),
        ..Default::default()
    }
}
