...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Flying, vigilance, haste\nWhenever a player attacks with three or more \
                      creatures, you draw a card.\nWhenever a player attacks with five or more \
                      creatures, Aurelia deals 3 damage to each of your opponents and you gain 3 \
                      life."
            .to_string(),
        power: Some(4),
        toughness: Some(4),
        ...
        completeness: Completeness::partial(
            "'Whenever a player attacks with 3+ creatures' trigger not in DSL",
        ),
        ..Default::default()
    }
}
