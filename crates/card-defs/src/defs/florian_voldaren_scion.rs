...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "First strike\nAt the beginning of each of your postcombat main phases, look \
                      at the top X cards of your library, where X is the total amount of life \
                      your opponents lost this turn. Exile one of those cards and put the rest on \
                      the bottom of your library in a random order. You may play the exiled card \
                      this turn."
            .to_string(),
        power: Some(3),
        toughness: Some(3),
        ...
        completeness: Completeness::partial(
            "no EffectAmount tracks life lost by all opponents this turn, and there is no 'look \
             at top X, exile one, you may play it...",
        ),
        ..Default::default()
    }
}
