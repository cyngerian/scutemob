...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Vigilance, haste\nAs Saskia enters, choose a player.\nWhenever a creature \
                      you control deals combat damage to a player, it deals that much damage to \
                      the chosen player."
            .to_string(),
        power: Some(3),
        toughness: Some(4),
        ...
        completeness: Completeness::partial(
            "DSL gap — 'As ~ enters, choose a player' is a replacement/choice effect on ETB with \
             persistent state (the chosen...",
        ),
        ..Default::default()
    }
}
