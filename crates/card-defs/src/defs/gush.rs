...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "You may return two Islands you control to their owner's hand rather than \
        ...
        completeness: Completeness::partial(
            "Alt cost 'return two Islands' — AltCostKind lacks bounce-lands variant",
        ),
        ..Default::default()
    }
}
