...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Casualty 1 (As you cast this spell, you may sacrifice a creature with power \
                      1 or greater. When you do, copy this spell and you may choose a new target \
                      for the copy.)\nCounter target spell unless its controller pays {2}."
            .to_string(),
        abilities: vec![
