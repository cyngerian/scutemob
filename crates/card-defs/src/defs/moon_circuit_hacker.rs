...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Ninjutsu {U}\nWhenever this creature deals combat damage to a player, you \
                      may draw a card. If you do, discard a card unless this creature entered \
                      this turn."
            .to_string(),
        power: Some(2),
        toughness: Some(1),
        ...
        completeness: Completeness::known_wrong(
            "the combat-damage draw always happens; the conditional discard clause is not modelled",
        ),
        ..Default::default()
    }
}
