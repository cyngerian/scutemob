...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Swampwalk (This creature can't be blocked as long as defending player \
                      controls a Swamp.)\nCycling\u{2014}Pay 2 life. (Pay 2 life, Discard this \
                      card: Draw a card.)"
            .to_string(),
        power: Some(3),
        toughness: Some(4),
        ...
        completeness: Completeness::partial(
            "Cycling with life cost (pay 2 life) — Cycling DSL only accepts ManaCost. Needs \
             LifeCycling DSL extension. Stripped to...",
        ),
        ..Default::default()
    }
}
