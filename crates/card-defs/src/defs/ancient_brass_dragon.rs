...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Flying\nWhenever this creature deals combat damage to a player, roll a d20. \
                      When you do, put any number of target creature cards with total mana value \
                      X or less from graveyards onto the battlefield under your control, where X \
                      is the result."
            .to_string(),
        power: Some(7),
        toughness: Some(6),
        ...
        completeness: Completeness::partial(
            "DSL gap — variable-count graveyard reanimation with total mana value constraint \
             based on dice roll result. The d20 roll...",
        ),
        ..Default::default()
    }
}
