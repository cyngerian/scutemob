...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "At the beginning of your draw step, you may draw two additional cards. If \
                      you do, choose two cards in your hand drawn this turn. For each of those \
        ...
        completeness: Completeness::inert(
            "Complex replacement/draw-step ability — 'draw two additional cards' then choose two \
             to pay 4 life or put back. Requires...",
        ),
        ..Default::default()
    }
}
