...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Glacial Ray deals 2 damage to any target.\nSplice onto Arcane {1}{R} (As \
                      you cast an Arcane spell, you may reveal this card from your hand and pay \
                      its splice cost. If you do, add this card's effects to that spell.)"
            .to_string(),
        abilities: vec![
