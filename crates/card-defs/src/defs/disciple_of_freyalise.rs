...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        completeness: Completeness::inert(
            "Authorable now: WhenEntersBattlefield + MayPayThenEffect{cost: \
             Cost::Sacrifice(creature, exclude self), then: \
             Sequence[GainLife{PowerOfSacrificedCreature}, \
             DrawCards{PowerOfSacrificedCreature}]}. Also needs the MDFC back face (Garden of \
             Freyalise, Land).",
        ),
        ..Default::default()
    }
