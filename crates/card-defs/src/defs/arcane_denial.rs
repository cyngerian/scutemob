...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Counter target spell. Its controller may draw up to two cards at the \
                      beginning of the next turn's upkeep.\nYou draw a card at the beginning of \
        ...
        completeness: Completeness::known_wrong(
            "counters and draws immediately; the delayed next-upkeep draws for both players are \
             not modelled",
        ),
        ..Default::default()
    }
