...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Changeling (This card is every creature type.)\nChampion a creature (When \
                      this enters, sacrifice it unless you exile another creature you control. \
                      When this leaves the battlefield, that card returns to the \
