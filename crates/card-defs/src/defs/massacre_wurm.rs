...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "When this creature enters, creatures your opponents control get -2/-2 until \
        ...
        completeness: Completeness::partial(
            "Blocked on PlayerTarget::ControllerOf resolution — 'that player loses 2 life' would \
             drain the Wurm's own controller (effects/mod.rs:3609/3661 resolve \
             ControllerOf/OwnerOf to ctx.controller). STALE: the PB-26 'WheneverCreatureDies \
             needs an opponent controller filter' claim — that filter exists and is wired.",
        ),
        ..Default::default()
    }
}
