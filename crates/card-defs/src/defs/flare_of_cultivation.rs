...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "You may sacrifice a nontoken green creature rather than pay this spell's \
                      mana cost.\nSearch your library for up to two basic land cards, reveal \
                      those cards, put one onto the battlefield tapped and the other into your \
                      hand, then shuffle."
            .to_string(),
        abilities: vec![
        ...
        completeness: Completeness::partial(
            "Alternative cost (sacrifice nontoken green creature) — AltCostKind lacks a \
             SacrificeCreature variant with...",
        ),
        ..Default::default()
    }
}
