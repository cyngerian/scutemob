...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Ninjutsu {1}{U} ({1}{U}, Return an unblocked attacker you control to hand: \
                      ...
                      the battlefield, except it's a Ninja in addition to its other creature \
                      types."
            .to_string(),
        power: Some(0),
        toughness: Some(0),
        ...
        completeness: Completeness::partial(
            "'enter as a copy of any creature, except it's also a Ninja' — needs ETB replacement \
             effect with BecomeCopyOf +...",
        ),
        ..Default::default()
    }
}
