...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Haste\nBattalion \u{2014} Whenever this creature and at least two other \
                      creatures attack, creatures you control gain first strike and trample until \
                      end of turn and can't be blocked by creature tokens this turn."
            .to_string(),
        power: Some(1),
        toughness: Some(1),
        abilities: vec![AbilityDefinition::Keyword(KeywordAbility::Haste)],
        completeness: Completeness::partial(
            "DSL gap — Battalion trigger requires checking that THIS creature is attacking plus \
             at least two others....",
        ),
        ..Default::default()
    }
