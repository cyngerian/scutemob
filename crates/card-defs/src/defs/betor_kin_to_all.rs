...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Flying\nAt the beginning of your end step, if creatures you control have \
                      total toughness 10 or greater, draw a card. Then if creatures you control \
                      have total toughness 20 or greater, untap each creature you control. Then \
                      if creatures you control have total toughness 40 or greater, each opponent \
        ...
        completeness: Completeness::partial(
            "Conditional toughness-threshold end step trigger too complex for DSL",
        ),
        ..Default::default()
    }
}
