...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Target creature you control gets +2/+2 until end of turn. It fights up to \
                      one target creature you don't control. (Each deals damage equal to its \
                      power to the other.)"
            .to_string(),
        abilities: vec![
            ...
            AbilityDefinition::Spell {
                ...
                targets: vec![
                    ...
                    TargetRequirement::UpToN {
                        count: 1,
                        inner: Box::new(TargetRequirement::TargetCreatureWithFilter(
                            TargetFilter {
