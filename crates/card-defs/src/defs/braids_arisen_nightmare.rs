...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "At the beginning of your end step, you may sacrifice an artifact, creature, \
                      enchantment, land, or planeswalker. If you do, each opponent may sacrifice \
                      a permanent of their choice that shares a card type with it. For each \
        ...
        completeness: Completeness::inert(
            "Complex end-step trigger with sacrifice choice, type-matching opponent sacrifice, \
             and conditional draw per opponent who...",
        ),
        ..Default::default()
    }
}
