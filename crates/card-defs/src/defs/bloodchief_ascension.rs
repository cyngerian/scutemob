...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "At the beginning of each end step, if an opponent lost 2 or more life this \
                      turn, you may put a quest counter on Bloodchief Ascension. (Damage causes \
                      loss of life.)\nWhenever a card is put into an opponent's graveyard from \
                      anywhere, if Bloodchief Ascension has three or more quest counters on it, \
                      you may have that player lose 2 life. If you do, you gain 2 life."
            .to_string(),
        abilities: vec![],
        completeness: Completeness::inert(
            "Both abilities are complex — end-step conditional counter placement needs 'opponent \
             lost 2+ life this turn' condition...",
        ),
        ..Default::default()
    }
}
