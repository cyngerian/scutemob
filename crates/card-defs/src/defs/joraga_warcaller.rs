...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Multikicker {1}{G}\nThis creature enters with a +1/+1 counter on it for \
                      each time it was kicked.\nOther Elf creatures you control get +1/+1 for \
        ...
        completeness: Completeness::partial(
            "DSL gap — 'enters with a +1/+1 counter for each time it was kicked' Needs ETB \
             replacement with count = kicker_times_paid",
        ),
        ..Default::default()
    }
}
