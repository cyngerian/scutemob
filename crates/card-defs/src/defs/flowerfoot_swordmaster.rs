...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Offspring {2} (You may pay an additional {2} as you cast this spell. If you \
                      do, when this creature enters, create a 1/1 token copy of it.)\nValiant — \
                      Whenever this creature becomes the target of a spell or ability you control \
                      for the first time each turn, Mice you control get +1/+0 until end of turn."
            .to_string(),
        power: Some(1),
        toughness: Some(2),
        abilities: vec![
        ...
        completeness: Completeness::partial(
            "Valiant needs 'targeted by a spell or ability YOU control'. PB-AC6's \
             WhenBecomesTarget.by_opponent is a bool — false...",
        ),
    }
}
