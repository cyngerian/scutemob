...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "You may have Spark Double enter as a copy of a creature or planeswalker you \
                      control, except it isn't legendary if that permanent is legendary, and it \
                      enters with an additional +1/+1 counter on it if it's a creature and an \
                      additional loyalty counter on it if it's a planeswalker."
            .to_string(),
        power: Some(0),
        toughness: Some(0),
        abilities: vec![
