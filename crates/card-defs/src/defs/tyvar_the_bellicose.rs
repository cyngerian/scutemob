...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Whenever one or more Elves you control attack, they gain deathtouch until \
                      end of turn.\nEach creature you control has \"Whenever a mana ability of \
        ...
        completeness: Completeness::inert(
            "DSL gap — 'Whenever one or more Elves you control attack' batch trigger with \
             deathtouch grant to the attacking Elves...",
        ),
        ..Default::default()
    }
}
