...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Look at the top seven cards of your library. You may put a creature card \
        ...
        completeness: Completeness::inert(
            "Blocked on optional single-card selection from a looked-at set (RevealAndRoute has \
             no cap and no 'you may') and on MV-conditional ETB +1/+1 counters keyed to the \
             selected card. Also an MDFC — the Turntimber, Serpentine Wood land back face is \
             unauthored.",
        ),
        ..Default::default()
    }
