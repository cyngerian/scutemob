...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Flying, first strike\nWhenever a commander you control enters or attacks, \
        ...
        completeness: Completeness::partial(
            "'Whenever a commander you control enters or attacks, proliferate' — no \
             TriggerCondition for 'when a commander you...",
        ),
        ..Default::default()
    }
}
