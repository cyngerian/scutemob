...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        types: full_types(&[], &[CardType::Creature], &["Porcupine", "Mount"]),
        oracle_text: "Whenever this creature attacks while saddled, it gets +1/+2 and gains \
                      menace until end of turn. (It can't be blocked except by two or more \
                      creatures.)\nSaddle 2 (Tap any number of other creatures you control with \
                      total power 2 or more: This Mount becomes saddled until end of turn. Saddle \
                      only as a sorcery.)"
            .to_string(),
        abilities: vec![
        ...
        completeness: Completeness::partial(
            "'Whenever this creature attacks while saddled, it gets +1/+2 and gains menace until \
             end of turn.' Requires...",
        ),
    }
}
