...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        types: full_types(&[SuperType::Legendary], &[CardType::Creature], &["Spirit"]),
        oracle_text: "Reach\nWhenever another permanent you control enters, if it wasn't put onto \
                      the battlefield with this ability, you may put a permanent card with equal \
                      or lesser mana value from your hand onto the battlefield.\nPartner (You can \
                      have two commanders if both have partner.)"
            .to_string(),
        power: Some(6),
        toughness: Some(6),
        abilities: vec![
        ...
        completeness: Completeness::partial(
            "Triggered ability — whenever another permanent you control enters, put a permanent \
             card from hand with equal or lesser...",
        ),
        ..Default::default()
    }
}
