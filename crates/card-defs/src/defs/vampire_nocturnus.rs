...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Play with the top card of your library revealed.\nAs long as the top card \
                      of your library is black, this creature and other Vampire creatures you \
        ...
        completeness: Completeness::inert(
            "DSL gap — 'Play with the top card of your library revealed.' Hidden info reveal not \
             in DSL",
        ),
        ..Default::default()
    }
