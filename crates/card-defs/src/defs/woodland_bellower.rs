...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "When this creature enters, you may search your library for a nonlegendary \
                      green creature card with mana value 3 or less, put it onto the battlefield, \
                      then shuffle."
            .to_string(),
        power: Some(6),
        toughness: Some(5),
        ...
        completeness: Completeness::partial(
            "TargetFilter lacks non_legendary — this searches any green creature with MV 3 or \
             less. When non_legendary is added, set...",
        ),
        ..Default::default()
    }
}
