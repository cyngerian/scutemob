...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Elves you control have \"Whenever this creature becomes tapped during your \
                      turn, untap it and put a +1/+1 counter on it. This ability triggers only \
                      once each turn.\""
            .to_string(),
        power: Some(3),
        toughness: Some(3),
        ...
        completeness: Completeness::inert(
            "DSL gap — granting triggered abilities to other creatures. Static grant of a \
             triggered ability (GrantTriggeredAbility)...",
        ),
        ..Default::default()
    }
}
