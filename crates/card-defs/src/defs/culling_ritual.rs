...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Destroy each nonland permanent with mana value 2 or less. Add {B} or {G} \
        ...
        completeness: Completeness::partial(
            "When variable-count mana generation with color choice is supported, add \
             Effect::Choose wrapping AddMana(B) / AddMana(G)...",
        ),
        ..Default::default()
    }
}
