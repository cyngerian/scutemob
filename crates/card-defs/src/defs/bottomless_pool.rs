...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "When you unlock this door, return up to one target creature to its owner's \
                      hand.\n(You may cast either half. That door unlocks on the battlefield. As \
                      a sorcery, you may pay the mana cost of a locked door to unlock it.)"
            .to_string(),
        abilities: vec![],
        completeness: Completeness::inert(
            "Blocked on the Room / door-unlock mechanic (CR 725): no 'when you unlock this door' \
             ...
             MoveZone to Hand with PlayerTarget::OwnerOf. Shares this blocker with \
             funeral_room.rs.",
        ),
        ..Default::default()
    }
