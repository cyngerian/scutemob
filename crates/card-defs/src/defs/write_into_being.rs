...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Look at the top two cards of your library. Manifest one of those cards, \
                      then put the other on the top or bottom of your library. (To manifest a \
                      card, put it onto the battlefield face down as a 2/2 creature. Turn it face \
        ...
        completeness: Completeness::partial(
            "Full oracle text requires 'look at top 2 cards, choose which to manifest, put the \
             other on top or bottom' — interactive...",
        ),
        ..Default::default()
    }
}
