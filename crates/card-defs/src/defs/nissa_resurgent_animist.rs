...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Landfall — Whenever a land you control enters, add one mana of any color. \
                      Then if this is the second time this ability has resolved this turn, reveal \
                      cards from the top of your library until you reveal an Elf or Elemental \
        ...
        completeness: Completeness::partial(
            "'second time this ability has resolved this turn' conditional — no per-ability \
             resolution counter exists. Only the mana...",
        ),
        ..Default::default()
    }
}
