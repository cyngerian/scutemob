...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Level up {1}{G} ({1}{G}: Put a level counter on this. Level up only as a \
                      sorcery.)\nLEVEL 1-4\n1/2\n{T}: Add {G}{G}.\nLEVEL 5+\n1/4\nElves you \
                      control have \"{T}: Add {G}{G}.\""
            .to_string(),
        power: Some(1),
        toughness: Some(1),
        abilities: vec![
        ...
        completeness: Completeness::partial(
            "Level up mechanic not in DSL — no LevelUp keyword or level-based ability gating. \
             Implementing only the base body and...",
        ),
        ..Default::default()
    }
}
