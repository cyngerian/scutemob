...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "When this enchantment enters and whenever you cast a spell with mana value \
                      5 or greater, draw a card."
            .to_string(),
        abilities: vec![
            // ETB: draw a card
        ...
        completeness: Completeness::partial(
            "'Whenever you cast a spell with mana value 5 or greater' — WheneverYouCastSpell \
             lacks mana value filter. Overbroad...",
        ),
        ..Default::default()
    }
}
