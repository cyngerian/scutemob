...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Draw a card for each different mana value among nonland permanents you \
                      control."
            .to_string(),
        ...
        completeness: Completeness::known_wrong(
            "draws a fixed 1 card instead of one per distinct mana value among nonland permanents \
             you control; EffectAmount has no distinct-mana-value count variant.",
        ),
        ..Default::default()
    }
}
