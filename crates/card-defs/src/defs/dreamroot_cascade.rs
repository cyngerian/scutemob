// Dreamroot Cascade — This land enters tapped unless you control two or more other lands. {T}: Add {G}
use crate::cards::helpers::*;

pub fn card() -> CardDefinition {
    CardDefinition {
        card_id: cid("dreamroot-cascade"),
        name: "Dreamroot Cascade".to_string(),
        mana_cost: None,
