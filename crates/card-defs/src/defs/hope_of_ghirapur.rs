...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Flying\nSacrifice Hope of Ghirapur: Until your next turn, target player who \
                      was dealt combat damage by Hope of Ghirapur this turn can't cast \
                      noncreature spells."
            .to_string(),
        power: Some(1),
        toughness: Some(1),
        ...
        completeness: Completeness::partial(
            "Sacrifice: target player dealt combat damage can't cast noncreature — PB-5+PB-13 \
             Cost::SacrificeSelf available; blocked...",
        ),
        ..Default::default()
    }
}
