...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Return target spell or nonland permanent an opponent controls to its \
                      owner's hand. You may cast an instant or sorcery spell with equal or lesser \
                      mana value from your hand without paying its mana cost."
            .to_string(),
        ...
        completeness: Completeness::partial(
            "Targets a spell or nonland permanent an opponent controls — dual zone targeting \
             (stack + battlefield). Bounce + free...",
        ),
        ..Default::default()
    }
}
