...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "You may have this creature enter as a copy of any creature on the \
                      battlefield, except it's an Illusion in addition to its other types and it \
                      has \"When this creature becomes the target of a spell or ability, \
                      sacrifice it.\""
            .to_string(),
        power: Some(0),
        toughness: Some(0),
        ...
        completeness: Completeness::partial(
            "'enter as a copy of any creature' — needs ETB replacement effect with BecomeCopyOf + \
             add Illusion subtype + add...",
        ),
        ..Default::default()
    }
}
