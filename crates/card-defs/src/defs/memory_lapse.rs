...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Counter target spell. If that spell is countered this way, put it on top of \
        ...
        completeness: Completeness::partial(
            "'put on top of library instead of graveyard' — requires counter-to-top variant. \
             CounterSpell currently sends to...",
        ),
        ..Default::default()
    }
}
