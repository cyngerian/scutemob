...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Whenever a creature you control becomes blocked, you may return it to its \
                      owner's hand."
            .to_string(),
        abilities: vec![
        ...
        completeness: Completeness::partial(
            "TriggerCondition::WhenBecomesBlocked does not exist in DSL. 'Whenever a creature you \
             control becomes blocked' fires...",
        ),
        ..Default::default()
    }
}
