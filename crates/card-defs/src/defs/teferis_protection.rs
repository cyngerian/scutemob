...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Until your next turn, your life total can't change and you gain protection \
                      from everything. All permanents you control phase out. (While they're \
                      phased out, they're treated as though they don't exist. They phase in \
                      before you untap during your untap step.)\nExile Teferi's Protection."
            .to_string(),
        ...
        completeness: Completeness::partial(
            "'your life total can't change' — needs a continuous prevention effect until next turn",
        ),
        ..Default::default()
    }
}
