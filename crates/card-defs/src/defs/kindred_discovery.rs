...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "As Kindred Discovery enters, choose a creature type.\nWhenever a creature \
                      you control of the chosen type enters or attacks, draw a card."
            .to_string(),
        // TODO: ChosenType designation not in DSL.
        abilities: vec![],
        completeness: Completeness::inert(
            "'Choose a creature type' — needs ChosenType designation on GameObject. Both trigger \
             conditions require knowing the...",
        ),
        ..Default::default()
    }
}
