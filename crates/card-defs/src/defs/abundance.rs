...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "If you would draw a card, you may instead choose land or nonland and reveal \
                      cards from the top of your library until you reveal a card of the chosen \
                      kind. Put that card into your hand and put all other cards revealed this \
                      way on the bottom of your library in any order."
            .to_string(),
        // TODO: Draw replacement effect too complex for DSL.
        abilities: vec![],
        completeness: Completeness::inert(
            "Draw replacement effect with player choice (land/nonland), reveal-until-found, and \
             bottom-of-library reorder. Far too...",
        ),
        ..Default::default()
    }
}
