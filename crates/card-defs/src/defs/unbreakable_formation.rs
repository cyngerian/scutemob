...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Creatures you control gain indestructible until end of turn.\nAddendum — If \
                      you cast this spell during your main phase, put a +1/+1 counter on each of \
                      those creatures and they gain vigilance until end of turn."
            .to_string(),
        ...
        completeness: Completeness::partial(
            "DSL gap — Addendum: 'if during main phase' condition check for +1/+1 counters + \
             vigilance grant....",
        ),
        ..Default::default()
    }
