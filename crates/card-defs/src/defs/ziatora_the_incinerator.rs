    ...
    CardDefinition {
        ...
        completeness: Completeness::partial(
            "Blocked on (1) optional sacrifice inside a triggered ability — Triggered has no \
             ...
             but ctx.sacrificed_creature_lki is only populated on the activated-ability-cost and \
             spell-additional-cost paths, so it would need threading to the trigger path too.",
        ),
        ..Default::default()
    }
}
