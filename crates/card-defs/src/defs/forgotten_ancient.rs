...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Whenever a player casts a spell, you may put a +1/+1 counter on this \
                      creature.\nAt the beginning of your upkeep, you may move any number of \
                      +1/+1 counters from this creature onto other creatures."
            .to_string(),
        power: Some(0),
        toughness: Some(3),
        abilities: vec![
        ...
        completeness: Completeness::inert(
            "Blocked on the upkeep ability: 'move any number of +1/+1 counters from this creature \
             ...
             abilities are 'you may' (no optional-effect wrapper; Effect::Choose is \
             non-interactive at effects/mod.rs:3190). NOT blocked on the trigger: 'whenever a \
             player casts a spell' is expressible as WheneverYouCastSpell \
             (card_definition.rs:3117) + WheneverOpponentCastsSpell together.",
        ),
        ..Default::default()
    }
}
