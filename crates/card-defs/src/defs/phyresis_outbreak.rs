...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Each opponent gets a poison counter. Then each creature your opponents \
        ...
        completeness: Completeness::inert(
            "The -1/-1 portion requires EffectAmount::CounterCountOf(target_controller, \
             CounterType::Poison) — a dynamic amount...",
        ),
        ..Default::default()
    }
}
