...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Spree (Choose one or more additional costs.)\n+ {2} \u{2014} Mill four \
                      cards. You may put up to two creature and/or land cards from among the \
                      milled cards into your hand.\n+ {4}{G} \u{2014} You may put up to two \
                      creature cards from your hand onto the battlefield.\n+ {1} \u{2014} \
                      Creatures you control with power 4 or greater gain hexproof and \
        ...
        completeness: Completeness::partial(
            "Spree mode 1 — mill 4, put up to two creature/land cards milled into hand",
        ),
        ..Default::default()
    }
}
