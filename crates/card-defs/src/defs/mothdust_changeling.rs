...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Changeling (This card is every creature type.)\nTap an untapped creature \
                      you control: This creature gains flying until end of turn."
            .to_string(),
        power: Some(1),
        toughness: Some(1),
        abilities: vec![AbilityDefinition::Keyword(KeywordAbility::Changeling)],
        completeness: Completeness::partial(
            "DSL gap — 'Tap an untapped creature you control' as an activated ability cost has no \
             Cost variant. The flying-granting...",
        ),
        ..Default::default()
    }
}
