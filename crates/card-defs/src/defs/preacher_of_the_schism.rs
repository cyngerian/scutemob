...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Deathtouch\nWhenever this creature attacks the player with the most life or \
                      tied for most life, create a 1/1 white Vampire creature token with \
                      lifelink.\nWhenever this creature attacks while you have the most life or \
                      are tied for most life, you draw a card and you lose 1 life."
            .to_string(),
        power: Some(2),
        toughness: Some(4),
        abilities: vec![
        ...
        completeness: Completeness::partial(
            "'Attacks the player with most life' conditional attack trigger not in DSL",
        ),
        ..Default::default()
    }
}
