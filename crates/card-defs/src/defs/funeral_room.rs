...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Whenever a creature you control dies, each opponent loses 1 life and you \
                      gain 1 life.\n(You may cast either half. That door unlocks on the \
                      battlefield. As a sorcery, you may pay the mana cost of a locked door to \
                      unlock it.)"
            .to_string(),
        abilities: vec![],
        completeness: Completeness::inert(
            "Blocked on the Room / door-unlock mechanic (CR 725): no two-door split-enchantment \
             ...
             Controller); Awakening Hall's door is unauthored. Shares this blocker with \
             bottomless_pool.rs.",
        ),
        ..Default::default()
    }
