...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Haste\nWhenever Laelia attacks, exile the top card of your library. You may \
                      ...
                      from your library and/or your graveyard, put a +1/+1 counter on Laelia."
            .to_string(),
        power: Some(2),
        toughness: Some(2),
        abilities: vec![
        ...
        completeness: Completeness::partial(
            "DSL gap — attack trigger that exiles top card + grants play permission. \
             Effect::PlayExiledCard exists but 'exile top...",
        ),
        ..Default::default()
    }
}
