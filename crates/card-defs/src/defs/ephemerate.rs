...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "Exile target creature you control, then return it to the battlefield under \
                      its owner's control.\nRebound (If you cast this spell from your hand, exile \
                      it as it resolves. At the beginning of your next upkeep, you may cast this \
        ...
        completeness: Completeness::partial(
            "Rebound keyword — not yet in the DSL KeywordAbility enum. Implementing the flicker \
             effect only; Rebound self-exile and...",
        ),
        ..Default::default()
    }
}
