...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "{T}: Add {C}. Put a point counter on Strixhaven Stadium.\nWhenever a \
                      creature deals combat damage to you, remove a point counter from Strixhaven \
                      Stadium.\nWhenever a creature you control deals combat damage to an \
                      opponent, put a point counter on Strixhaven Stadium. Then if it has ten or \
                      more point counters on it, remove them all and that player loses the game."
            .to_string(),
        abilities: vec![
        ...
        completeness: Completeness::partial(
            "Complex triggered abilities — combat damage triggers with point counter tracking and \
             'loses the game' win condition....",
        ),
        ..Default::default()
    }
}
