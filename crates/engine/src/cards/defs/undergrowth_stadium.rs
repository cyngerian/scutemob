// Undergrowth Stadium — This land enters tapped unless you have two or more opponents. {T}: Add {B} or {
use crate::cards::helpers::*;

pub fn card() -> CardDefinition {
    CardDefinition {
        card_id: cid("undergrowth-stadium"),
        name: "Undergrowth Stadium".to_string(),
        mana_cost: None,
