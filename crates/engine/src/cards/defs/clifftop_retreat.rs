...
pub fn card() -> CardDefinition {
    CardDefinition {
        card_id: cid("clifftop-retreat"),
        name: "Clifftop Retreat".to_string(),
        mana_cost: None,
        ...
        abilities: vec![            AbilityDefinition::Replacement {
                ...
                is_self: true,
                unless_condition: Some(Condition::ControlLandWithSubtypes(vec![SubType("Mountain".to_string()), SubType("Plains".to_string())])),
            },
