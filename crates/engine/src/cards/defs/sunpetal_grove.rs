// Sunpetal Grove — This land enters tapped unless you control a Forest or a Plains. {T}: Add {G} or
use crate::cards::helpers::*;

pub fn card() -> CardDefinition {
    CardDefinition {
        card_id: cid("sunpetal-grove"),
        ...
        abilities: vec![            AbilityDefinition::Replacement {
                ...
                is_self: true,
                unless_condition: Some(Condition::ControlLandWithSubtypes(vec![SubType("Forest".to_string()), SubType("Plains".to_string())])),
            },
