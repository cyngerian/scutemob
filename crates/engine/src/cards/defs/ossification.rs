// Ossification — {1}{W} Enchantment — Aura
// Enchant basic land you control
// When Ossification enters the battlefield, exile target creature or planeswalker an
// opponent controls until Ossification leaves the battlefield.
//
...
pub fn card() -> CardDefinition {
    ...
    CardDefinition {
        ...
        abilities: vec![
            ...
            // ETB: exile target creature or planeswalker an opponent controls until this leaves.
