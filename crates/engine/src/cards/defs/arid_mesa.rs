...
pub fn card() -> CardDefinition {
    CardDefinition {
        ...
        oracle_text: "{T}, Pay 1 life, Sacrifice Arid Mesa: Search your library for a Mountain or Plains card, put it onto the battlefield tapped, then shuffle.".to_string(),
        abilities: vec![
