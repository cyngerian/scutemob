// Concealed Courtyard — This land enters tapped unless you control two or fewer other lands. {T}: Add {W
use crate::cards::helpers::*;

pub fn card() -> CardDefinition {
    CardDefinition {
        card_id: cid("concealed-courtyard"),
        name: "Concealed Courtyard".to_string(),
        mana_cost: None,
        types: types(&[CardType::Land]),
        oracle_text: "This land enters tapped unless you control two or fewer other lands.\n{T}: Add {W} or {B}.".to_string(),
        abilities: vec![
            // TODO: Conditional ETB — enters tapped unless you control two or fewer other lands
