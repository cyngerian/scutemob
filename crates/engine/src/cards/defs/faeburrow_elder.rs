...
//
// TODO: DSL gap — "gets +1/+1 for each color among permanents you control" is a static
// continuous effect whose value depends on counting distinct colors among permanents you
// control. No EffectAmount variant exists for this calculation.
// The P/T pump is omitted; base P/T is 0/0 as printed.
//
