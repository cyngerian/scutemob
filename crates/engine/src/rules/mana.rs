...
///
/// CR 605.3b: a mana ability doesn't use the stack and resolves immediately. CR 605.1a:
/// a mana ability is an activated ability, not a CR 116.2 special action. CR 117.3b's
/// parenthetical ("other than a mana ability") is why a mana ability does not hand
/// priority back to the active player the way a resolution does. The player retains
...
pub fn handle_tap_for_mana(
    ...
    //     CR 117.3c: the activating player receives priority afterward — and the `:52`
