...
// PB-EF7 (2026-07-18): re-pinned on the 49→50 bump — version 49 became a
// superseded row and joined the frozen prefix. Its bytes (the v49 fingerprints)
// are unchanged; the digest moved only because the prefix gained a member.
const FROZEN_HISTORY_PREFIX_DIGEST: &str =
    "50af9724d540edb3baf261078eed3e1bda94779de659e40b434c4cf564acf182";
