...
// PB-EF9 (2026-07-18): re-pinned on the 51→52 bump — version 51 became a
// superseded row and joined the frozen prefix. Its bytes (the v51 fingerprints)
