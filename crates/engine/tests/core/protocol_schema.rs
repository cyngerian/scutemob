...
// PB-DP7 (2026-07-26): re-pinned on the 27→28 bump — version 27 (the former
// tail) joined the frozen prefix when version 28 shipped.
// PB-DP8 fix cycle (2026-07-26): re-pinned on the 29→30 bump — versions 28 and 29
// joined the frozen prefix.
// PB-DX1 (2026-08-01): re-pinned on the 31→32 bump — version 31 (the former
// tail) joined the frozen prefix when version 32 shipped.
// PB-DX6 (2026-08-02): re-pinned on the 32→33 bump — version 32 (the former
...
// PB-DX27 rider (2026-08-13): re-pinned on the 35→36 bump — version 35 (the
// former tail) joined the frozen prefix when version 36 shipped.
// PB-DX28 (2026-08-14): re-pinned on the 36→37 bump — version 36 (the former
// tail) joined the frozen prefix when version 37 shipped.
// PB-DX44 stage 2a (2026-08-15): re-pinned on the 37→38 bump — version 37 (the
// former tail) joined the frozen prefix when version 38 shipped.
...
// PB-DX53 (2026-09-05): re-pinned on the 43→44 bump — version 43 (the former
// tail) joined the frozen prefix when version 44 shipped.
const FROZEN_HISTORY_PREFIX_DIGEST: &str =
    "e715027ebef013b316655c5edd2f7660e0a0bbba4ce299fb2a844107e0ed44d5";
