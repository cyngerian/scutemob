...
use mtg_engine::{
    ...
    CardType, Command, CounterType, GameEvent, GameStateBuilder, KeywordAbility, ManaColor,
    ManaCost, ObjectSpec, PlayerId, Step, ZoneId,
};
    ...
    CardDefinition {
        ...
        abilities: vec![
            ...
            AbilityDefinition::AltCastAbility {
                ...
                details: Some(AltCastDetails::Escape { exile_count: 5 }),
            },
    ...
    CardDefinition {
        ...
        abilities: vec![
            ...
            AbilityDefinition::AltCastAbility {
                ...
                details: Some(AltCastDetails::Escape { exile_count: 2 }),
            },
    ...
    CardDefinition {
        ...
        abilities: vec![
            ...
            AbilityDefinition::AltCastAbility {
                ...
                details: Some(AltCastDetails::Escape { exile_count: 1 }),
            },
        ],
        ..Default::default()
    }
...
fn test_escape_basic_cast_from_graveyard() {
    ...
    let (state, cast_events) = process_command(
        ...
        Command::CastSpell {
            ...
            additional_costs: vec![AdditionalCost::EscapeExile {
                cards: vec![fodder_a_id, fodder_b_id, fodder_c_id],
            }],
            prototype: false,
            modes_chosen: vec![],
            x_value: 0,
...
fn test_escape_exile_card_not_in_graveyard_rejected() {
    ...
    let result = process_command(
        ...
        Command::CastSpell {
            ...
            alt_cost: Some(AltCostKind::Escape),
            additional_costs: vec![AdditionalCost::EscapeExile {
                cards: vec![hand_id, gy1_id, gy2_id],
            }],
            prototype: false,
            modes_chosen: vec![],
            x_value: 0,
