...
fn test_retrace_basic_cast_from_graveyard() {
    ...
    let result = process_command(
        ...
        Command::CastSpell {
            ...
            kicker_times: 0,
            alt_cost: None,
            additional_costs: vec![AdditionalCost::Discard(vec![mountain_id])],
            prototype: false,
            modes_chosen: vec![],
            x_value: 0,
            face_down_kind: None,
...
fn test_retrace_discard_must_be_land() {
    ...
    let result = process_command(
        ...
        Command::CastSpell {
            ...
            kicker_times: 0,
            alt_cost: None,
            additional_costs: vec![AdditionalCost::Discard(vec![non_land_id])],
            prototype: false,
            modes_chosen: vec![],
            x_value: 0,
            face_down_kind: None,
...
fn test_retrace_recast_after_resolution() {
    ...
    let (state, _) = process_command(
        ...
        Command::CastSpell {
            ...
            kicker_times: 0,
            alt_cost: None,
            additional_costs: vec![AdditionalCost::Discard(vec![mountain1_id])],
            prototype: false,
            modes_chosen: vec![],
            x_value: 0,
            face_down_kind: None,
    ...
    let result2 = process_command(
        ...
        Command::CastSpell {
            ...
            kicker_times: 0,
            alt_cost: None,
            additional_costs: vec![AdditionalCost::Discard(vec![mountain2_id])],
            prototype: false,
            modes_chosen: vec![],
            x_value: 0,
            face_down_kind: None,
