...
- **Active Plan**: **W6 Primitive + Card Authoring** — primitives DONE; **card authoring operations**: `docs/card-authoring-operations.md` (**Phase 2 IN PROGRESS** — **A-24 through A-28 COMPLETE (61 new cards)**; next: A-29 cant-restriction). W5 RETIRED. Goal: all 1,743 cards complete pre-alpha, zero TODOs.
...
- **Last Updated**: 2026-03-23 (A-24 through A-28: 61 new cards; ~1452 card defs total; 2281 tests, 0 clippy)
