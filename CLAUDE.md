...
- **Active Plan**: **W6 Primitive + Card Authoring** — **Phase 2.5 DSL gap closure COMPLETE (PB-0–37)**. BF-1 re-triage done: 678/1451 files have TODOs, ~100 fixable now. **Next: BF-S1–S9 backfill fix sprint**, then resume A-29+ authoring. W5 RETIRED. Goal: all 1,743 cards complete pre-alpha, zero TODOs.
...
- **Last Updated**: 2026-03-30 (BF-1 re-triage: 1451 card defs, 773 clean (53%), 678 with TODOs (1070 lines), ~100 fixable now across 131 candidates; BF-2 gap closure committed; 9 backfill fix sessions planned (BF-S1–S9); 2437 tests, 0 clippy)
