...
- **Status**: 2403 tests passing; ~195 validated; 42/42 P1; 17/17 P2; 40/40 P3; 95/105 P4 (95/95 implemented; 0 planned; 9 permanent-n/a; 1 deferred: Banding post-alpha); Batch 0-16 + Mutate + Transform + Morph + Dungeon + Ring complete; Type consolidation COMPLETE; **ALL PRIMITIVE BATCHES COMPLETE (PB-0 through PB-21)**; **PB-22 deferred cleanup ALL 7 SESSIONS DONE**; W6-review 21/21 COMPLETE; 0 HIGH/MEDIUM open; **~29 LOW open**; W3 LOW sprint COMPLETE; **PB-23 DONE**; **PB-24 DONE**; **PB-25 DONE**; **PB-26 DONE**; **PB-27 DONE**; **PB-28 DONE**; **PB-29 DONE**; **PB-30 DONE**; **PB-31 DONE**; **PB-32 DONE**; **PB-33 DONE** (copy/clone + exile/flicker timing G-22/G-28, DelayedTrigger system + ExileWithDelayedReturn + CreateTokenCopy extensions, 15 cards fixed, 2H 1M fixed)
- **Active Plan**: **W6 Primitive + Card Authoring** — **Phase 2.5 DSL gap closure IN PROGRESS**: PB-23 through PB-33 DONE; PB-34 through PB-37 planned. `docs/dsl-gap-closure-plan.md` (full gap inventory). Card authoring paused at A-28 until gaps close. W5 RETIRED. Goal: all 1,743 cards complete pre-alpha, zero TODOs.
...
- **Last Updated**: 2026-03-27 (PB-33 DONE: copy/clone + exile/flicker timing G-22/G-28; DelayedTrigger expanded system (AtNextEndStep/AtOwnersNextEndStep/WhenSourceLeavesBattlefield/AtEndOfCombat), ExileWithDelayedReturn effect, CreateTokenCopy extended (gains_haste/except_not_legendary/delayed_action), TokenSpec sacrifice_at_end_step/exile_at_end_step, SetReturnToHandAtEndStep, EquippedCreature target, RemoveSuperType layer modification; 15 card defs fixed (kiki-jiki, fire-crystal, helm-of-the-host, miirym, eternal-wanderer, brutal-cathar, nezahal, chandra-flamecaller, voice-of-victory, zurgo-stormrender, locust-god, puppeteer-clique, mirage-phalanx, thousand-faced-shadow, mist-syndicate-naga); 7 new tests; 2403 tests, 0 clippy)
