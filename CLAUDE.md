...
- **Last Updated**: 2026-07-17 (**SR-35 ready for collection, `scutemob-91`** — the card corpus is
  ...
  **1,380/1,748 defs inert** under *direct* rustfmt. `format_strings=true` → 0 inert;
  ...
  See the SR-35 bullet above. Earlier: SR-33 collected, `scutemob-89` merge `953cc5a6` — 88 `Effect::Choose`
