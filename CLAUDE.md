...
- **Status**: 2419 tests passing; ~195 validated; 42/42 P1; 17/17 P2; 40/40 P3; 95/105 P4 (95/95 implemented; 0 planned; 9 permanent-n/a; 1 deferred: Banding post-alpha); Batch 0-16 + Mutate + Transform + Morph + Dungeon + Ring complete; Type consolidation COMPLETE; **ALL PRIMITIVE BATCHES COMPLETE (PB-0 through PB-21)**; **PB-22 deferred cleanup ALL 7 SESSIONS DONE**; W6-review 21/21 COMPLETE; 0 HIGH/MEDIUM open; **~29 LOW open**; W3 LOW sprint COMPLETE; **PB-23 DONE**; **PB-24 DONE**; **PB-25 DONE**; **PB-26 DONE**; **PB-27 DONE**; **PB-28 DONE**; **PB-29 DONE**; **PB-30 DONE**; **PB-31 DONE**; **PB-32 DONE**; **PB-33 DONE**; **PB-34 DONE**; **PB-35 DONE** (modal triggers G-27 + graveyard abilities G-29, ActivationZone/TriggerZone enums, modal trigger dispatch, 14 card defs fixed, 1H 3M fixed)
- **Active Plan**: **W6 Primitive + Card Authoring** — **Phase 2.5 DSL gap closure IN PROGRESS**: PB-23 through PB-35 DONE; PB-36 through PB-37 planned. `docs/dsl-gap-closure-plan.md` (full gap inventory). Card authoring paused at A-28 until gaps close. W5 RETIRED. Goal: all 1,743 cards complete pre-alpha, zero TODOs.
...
- **Last Updated**: 2026-03-28 (PB-35 DONE: modal triggers G-27 + graveyard abilities G-29; ActivationZone/TriggerZone enums, modal trigger dispatch in flush_pending_triggers+resolution.rs; 14 card defs fixed (retreat_to_kazandu/coralhelm, felidar_retreat, junji, shambling_ghast, tectonic_giant, hullbreaker_horror, glissa_sunslayer, goblin_cratermaker, umezawas_jitte, reassembling_skeleton, bloodghast, earthquake_dragon, cult_conscript); G-30 PW deferred to PB-37; 11 new tests; 2419 tests, 0 clippy)
