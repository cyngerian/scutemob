...
- **Status**: 2648 tests passing; ~195 validated; 42/42 P1; 17/17 P2; 40/40 P3; 95/105 P4 (95/95 implemented; 9 permanent-n/a; 1 deferred: Banding post-alpha); Batch 0-16 + Mutate + Transform + Morph + Dungeon + Ring complete; Type consolidation COMPLETE; **ALL PRIMITIVE BATCHES COMPLETE (PB-0 through PB-21)**; PB-22 deferred cleanup DONE; W6-review 21/21 COMPLETE; 0 HIGH/MEDIUM open; **~45 LOW open** (PB-N added +8: PB-N-L01 + BASELINE-LKI-01 + BASELINE-CLIPPY-01..06); W3 LOW sprint COMPLETE; PB-23–37 DONE; **PB-A/B/E/J/M/S/X/Q/Q4/N DONE**; PB-Q2/Q3/Q5 reserved (planned)
- **Active Plan**: **W6 Primitive + Card Authoring** — **PB-D plan-complete 2026-04-13** (`b9f43bf1`), awaiting oversight greenlight before implement. Verdict PASS-AS-NEW-VARIANT (`TargetController::DamagedPlayer`); 6 confirmed cards of 15 classified (~40% yield, low end of filter-PB band); 7 mandatory + 2 optional tests; plan file `memory/primitives/pb-plan-D.md`. **PB-P pre-check finding**: real PB but narrower than its name — `EffectAmount::PowerOf(EffectTarget)` already exists; real gap is `PowerOf(SacrificedCreature)` LKI read (Altar of Dementia, Greater Good) — oversight to re-triage after PB-D closes. PB-L rank 3 at ~3-4 calibrated yield. Old queue (PB-R, PB-Q3, PB-T, PB-U, PB-V, PB-W, PB-Y, PB-Q2/Q5) demoted — opportunistic only. See `docs/primitive-card-plan.md` Phase 1.8. W5 RETIRED.
...
- **Last Updated**: 2026-04-13 (PB-D plan-complete — PASS-AS-NEW-VARIANT, 6 cards confirmed, PB-P narrow-gap finding, awaiting greenlight; tests unchanged at 2648)
