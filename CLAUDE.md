...
- `testing/`: Script replay harness (`crates/engine/src/testing/replay_harness.rs` — public, shared with replay viewer), 71 approved game scripts, 697 tests; 6-player test suite; 54 property invariant tests; `declare_attackers`/`declare_blockers` action types
