...
- **Active Plan**: **W6 Primitive + Card Authoring** — **Phase 2.5 DSL gap closure COMPLETE (PB-0–37)**. **Backfill COMPLETE**. **Wave A COMPLETE** (91 new card defs). **Wave A engine review CLEAN**. **Wave B in progress**: A-38 53/105 authored (48 BLOCKED), A-42 77/131 authored (~54 BLOCKED). **Next: Wave B engine review checkpoint, then Wave C or new PBs for BLOCKED cards**. W5 RETIRED. Goal: all 1,743 cards complete pre-alpha, zero TODOs.
...
- **Last Updated**: 2026-04-01 (Wave B: A-42 batch 2 — 60 new card defs; A-42 total 77/131; 1693 total defs; 2437 tests, 0 clippy)
