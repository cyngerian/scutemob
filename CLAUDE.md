...
- **Active Plan**: **W6 Primitive + Card Authoring** — **Phase 2.5 DSL gap closure COMPLETE (PB-0–37)**. **Backfill COMPLETE** (32 fixes across BF-S1–S4; S5–S9 exhausted). **A-29 S1 DONE** (21 card defs authored). **Next: A-29 session 131**, then A-30+. W5 RETIRED. Goal: all 1,743 cards complete pre-alpha, zero TODOs.
...
- **Last Updated**: 2026-03-30 (A-29 S131: 3 engine primitives — CardDefinition.cant_be_countered, ETBTriggerFilter.color_filter, MaxNoncreature/NonartifactSpellsPerTurn restrictions; 10 card defs fixed; 2437 tests, 0 clippy)
