...
- **Active Plan**: **W6 Primitive + Card Authoring** — **Phase 2.5 DSL gap closure COMPLETE (PB-0–37)**. **Backfill COMPLETE**. **Wave A COMPLETE**. **Wave A+B engine reviews CLEAN**. **Wave B.5 in progress**: PB-N done (19 misc cards), **PB-G DONE** (BounceAll + 4 cards). **Next: PB-K → PB-D → PB-C → PB-F → PB-I → PB-H** (see ops plan). W5 RETIRED. Goal: all 1,743 cards complete pre-alpha, zero TODOs.
...
- **Last Updated**: 2026-04-02 (PB-N 19 misc defs + PB-G BounceAll engine batch + 4 new cards + 2 fixes; ~1716 total defs; 2445 tests, 0 clippy)
