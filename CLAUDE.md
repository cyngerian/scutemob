...
- **Status**: 2428 tests passing; ~195 validated; 42/42 P1; 17/17 P2; 40/40 P3; 95/105 P4 (95/95 implemented; 0 planned; 9 permanent-n/a; 1 deferred: Banding post-alpha); Batch 0-16 + Mutate + Transform + Morph + Dungeon + Ring complete; Type consolidation COMPLETE; **ALL PRIMITIVE BATCHES COMPLETE (PB-0 through PB-21)**; **PB-22 deferred cleanup ALL 7 SESSIONS DONE**; W6-review 21/21 COMPLETE; 0 HIGH/MEDIUM open; **~29 LOW open**; W3 LOW sprint COMPLETE; **PB-23 DONE**; **PB-24 DONE**; **PB-25 DONE**; **PB-26 DONE**; **PB-27 DONE**; **PB-28 DONE**; **PB-29 DONE**; **PB-30 DONE**; **PB-31 DONE**; **PB-32 DONE**; **PB-33 DONE**; **PB-34 DONE**; **PB-35 DONE**; **PB-36 DONE** (evasion/protection extensions G-31, BlockingExceptionFilter enum, CantBlock KW-160/CantBeBlockedExceptBy KW-161, Effect::GrantPlayerProtection, combat.rs enforcement, 14 card defs fixed, 9 new tests)
- **Active Plan**: **W6 Primitive + Card Authoring** — **Phase 2.5 DSL gap closure IN PROGRESS**: PB-23 through PB-36 DONE; PB-37 planned. `docs/dsl-gap-closure-plan.md` (full gap inventory). Card authoring paused at A-28 until gaps close. W5 RETIRED. Goal: all 1,743 cards complete pre-alpha, zero TODOs.
...
- **Last Updated**: 2026-03-29 (PB-36 DONE: evasion/protection extensions G-31; BlockingExceptionFilter enum (HasKeyword/HasAnyKeyword with Box to break recursive cycle); CantBlock(160)/CantBeBlockedExceptBy(161) in KeywordAbility; Effect::GrantPlayerProtection(73); combat.rs blocker validation for both new KWs; hash.rs/view_model.rs/lib.rs/mod.rs/helpers.rs updated; 14 card defs fixed (bloodghast+cantblock, carrion_feeder, phoenix_chick, skrelv, vishgraz, skrevls_hive, white_suns_twilight, signal_pest, gingerbrute, emrakul, greensleeves, sword_of_body_and_mind, cryptic_coat, untimely_malfunction, teferis_protection, the_one_ring); 9 new tests; 2428 tests, 0 clippy)

### What Exists (M9.5 complete + 90 abilities through Batch 15 + Mutate + Transform, includes M0-M9 + Engine Core Complete checkpoint)
- `cards/`: CardDefinition framework (30+ Effect primitives), ~1452 card defs (149 hand-authored + 114 Phase 1 templates + 82 Phase 2 Wave 1 + 108 prior + 88 Phase 2 Tier 1 + 88 Phase 2 Tier 2 + 162 A-18 draw + 144 A-19 token-create + 121 A-20/A-21/A-22/A-23 + 61 A-24/A-25/A-26/A-27/A-28 + 334 prior Phase 2), CardRegistry
