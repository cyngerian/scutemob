...
- **Status**: 2437 tests passing; ~195 validated; 42/42 P1; 17/17 P2; 40/40 P3; 95/105 P4 (95/95 implemented; 0 planned; 9 permanent-n/a; 1 deferred: Banding post-alpha); Batch 0-16 + Mutate + Transform + Morph + Dungeon + Ring complete; Type consolidation COMPLETE; **ALL PRIMITIVE BATCHES COMPLETE (PB-0 through PB-21)**; **PB-22 deferred cleanup ALL 7 SESSIONS DONE**; W6-review 21/21 COMPLETE; 0 HIGH/MEDIUM open; **~29 LOW open**; W3 LOW sprint COMPLETE; **PB-23 DONE**; **PB-24 DONE**; **PB-25 DONE**; **PB-26 DONE**; **PB-27 DONE**; **PB-28 DONE**; **PB-29 DONE**; **PB-30 DONE**; **PB-31 DONE**; **PB-32 DONE**; **PB-33 DONE**; **PB-34 DONE**; **PB-35 DONE**; **PB-36 DONE**; **PB-37 DONE** (complex activated ability residuals G-26: Condition::WasCast, EffectDuration::UntilYourNextTurn(PlayerId), once_per_turn on Activated/ActivatedAbility, was_cast+abilities_activated_this_turn on GameObject, temporary_protection_qualities on PlayerState, expire_until_next_turn_effects() sweep at untap step, 7 card defs fixed, 9 new tests)
- **Active Plan**: **W6 Primitive + Card Authoring** — **Phase 2.5 DSL gap closure IN PROGRESS**: PB-23 through PB-37 DONE. `docs/dsl-gap-closure-plan.md` (full gap inventory). Card authoring paused at A-28 until gaps close. W5 RETIRED. Goal: all 1,743 cards complete pre-alpha, zero TODOs.
...
- **Last Updated**: 2026-03-29 (PB-37 DONE: Condition::WasCast CR 603.4 + EffectDuration::UntilYourNextTurn(PlayerId) CR 611.2b + once_per_turn:bool on Activated/ActivatedAbility CR 602.5g + was_cast/abilities_activated_this_turn on GameObject + temporary_protection_qualities on PlayerState + expire_until_next_turn_effects() in layers.rs called from untap step; 7 card defs fixed (the_one_ring full rewrite, geological_appraiser, teferis_protection, elspeth_storm_slayer, kaito_dancing_shadow, ramos_dragon_engine, steel_hellkite); 9 new tests; 2437 tests, 0 clippy)
