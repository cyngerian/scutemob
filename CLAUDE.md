...
- **Status**: 2616 tests passing; ~195 validated; 42/42 P1; 17/17 P2; 40/40 P3; 95/105 P4 (95/95 implemented; 9 permanent-n/a; 1 deferred: Banding post-alpha); Batch 0-16 + Mutate + Transform + Morph + Dungeon + Ring complete; Type consolidation COMPLETE; **ALL PRIMITIVE BATCHES COMPLETE (PB-0 through PB-21)**; PB-22 deferred cleanup DONE; W6-review 21/21 COMPLETE; 0 HIGH/MEDIUM open; **~35 LOW open**; W3 LOW sprint COMPLETE; PB-23–37 DONE; **PB-A/B/E/J/M/S/X DONE** (PB-X closed 2026-04-11 — A-42 Tier 1 micro-PB shipped `AllCreaturesExcludingSubtype`/`AllCreaturesExcludingChosenSubtype` EffectFilters, `LayerModification::ModifyBothDynamic` substituted at Effect::ApplyContinuousEffect per CR 608.2h, `Cost::ExileSelf` + `ActivationCost.exile_self` via existing `embedded_effect` LKI plumbing; 6 cards unblocked; 16 tests; 1 HIGH fixed — Obelisk rewritten Triggered→Replacement per CR 614.12)
- **Active Plan**: **W6 Primitive + Card Authoring** — Wave B.5 HIGH batches COMPLETE. **PB-X CLOSED 2026-04-11**. Next: **PB-Q (ChooseColor)** — highest-yield next primitive, unblocks 9+ cards. Metallic Mimic parked as **PB-Y** (AddChosenCreatureType); do NOT schedule ahead of PB-Q. Heritage Druid still parked on cost-framework PB. Revised slate: PB-Q → PB-R (ExchangeZones) → PB-T+V → PB-U → PB-Y → PB-W. Reports: `memory/primitives/pb-plan-X.md`, `memory/primitives/pb-review-X.md`. W5 RETIRED.
...
- **Last Updated**: 2026-04-11 (PB-X closed; 2616 tests; next: PB-Q ChooseColor plan)
