...
- **Last Updated**: 2026-07-10 (SR-2 — invariant #9 registry gate; 3104 tests, clean coverage 57.6%. The prior 56.2% was an undercount: the authoring report's `abilities: vec![]` regex also matched nested `mana_abilities: vec![]`.)
