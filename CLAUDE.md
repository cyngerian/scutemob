...
- **Active Plan**: **W6 Primitive + Card Authoring** — **Phase 2.5 DSL gap closure IN PROGRESS**: PB-23 DONE; PB-24 DONE; PB-25 DONE; PB-26 DONE; PB-27 DONE; PB-28 DONE; PB-29 DONE; PB-30 DONE; PB-31 DONE; PB-32 DONE; PB-33 through PB-37 planned. `docs/dsl-gap-closure-plan.md` (full gap inventory). Card authoring paused at A-28 until gaps close. W5 RETIRED. Goal: all 1,743 cards complete pre-alpha, zero TODOs.
...
- **Last Updated**: 2026-03-26 (PB-32 DONE: static/effect primitives G-18/G-19/G-20/G-21, AdditionalLandPlay + AdditionalLandPlays static + PreventAllCombatDamage + PreventCombatDamageFromOrTo + GainControl + ExchangeControl + EffectFilter::AttachedPermanent, 22 card defs fixed, 2M fixed; 2396 tests, 0 clippy)
