...
- **Active Plan**: W5 card authoring — `test-data/test-cards/AUTHORING_PLAN.md` (1,743 card universe, 3-phase pipeline); Wave 1 done (453 card defs total)
...
- **Last Updated**: 2026-03-12 (W5 Phase 2 Wave 1 complete — 82 land-etb-tapped cards, 453 total defs)
