...
- **Status**: 2639 tests passing; ~195 validated; 42/42 P1; 17/17 P2; 40/40 P3; 95/105 P4 (95/95 implemented; 9 permanent-n/a; 1 deferred: Banding post-alpha); Batch 0-16 + Mutate + Transform + Morph + Dungeon + Ring complete; Type consolidation COMPLETE; **ALL PRIMITIVE BATCHES COMPLETE (PB-0 through PB-21)**; PB-22 deferred cleanup DONE; W6-review 21/21 COMPLETE; 0 HIGH/MEDIUM open; **~37 LOW open**; W3 LOW sprint COMPLETE; PB-23–37 DONE; **PB-A/B/E/J/M/S/X/Q/Q4 DONE**; PB-Q2/Q3/Q5 reserved (planned)
- **Active Plan**: **W6 Primitive + Card Authoring** — PB-Q4 closed; **PB queue re-prioritized from TODO classification data (2026-04-12)**. New top-4: **PB-N** (SubtypeFilteredAttack+Death triggers, ~20 yield) → **PB-D** (DamagedPlayer target filter, ~9) → **PB-L** (Landfall trigger, ~7) → **PB-P** (PowerOfCreature EffectAmount, ~9). Old queue (PB-R, PB-Q3, PB-T, PB-U, PB-V, PB-W, PB-Y, PB-Q2/Q5) demoted — opportunistic only. See `docs/primitive-card-plan.md` Phase 1.8. Pre-launch: stale-TODO check on song_of_freyalise / bootleggers_stash / throne_of_eldraine. W5 RETIRED.
...
- **Last Updated**: 2026-04-12 (PB queue re-prioritized from classification data; PB-N queued next; 2639 tests)
