...
- **Active Plan**: **W6 Primitive + Card Authoring** — **Phase 2.5 DSL gap closure COMPLETE (PB-0–37)**. BF-1 re-triage done: 678/1451 files have TODOs. **BF-S1+S2 DONE** (25 card def fixes). **Next: BF-S3–S9**, then resume A-29+ authoring. W5 RETIRED. Goal: all 1,743 cards complete pre-alpha, zero TODOs.
...
- **Last Updated**: 2026-03-30 (BF-S2 complete: 8 card defs fixed across 8 files; 25 total BF fixes; ~785 clean, ~80 fixable, ~578 blocked; 2437 tests, 0 clippy)
