...
- **Active Milestone**: M9.5 DONE — **Card Authoring Campaign ACTIVE** (plan: `memory/card-authoring/campaign-plan-2026-05-16.md` §0; clean coverage **1,117/1,798 = 62.1%** per `tools/authoring-report.py`). **ACTIVE QUEUE: PB-OS1..OS11** (`memory/primitives/oos-retriage-plan-2026-07-18.md`) — **OS1..OS3 SHIPPED** (correctness group, `scutemob-116`/`128`/`129`), **OS4 IN FLIGHT** (`scutemob-130`, return-transformed DFCs), OS5..OS11 pending; DOCB-2/3 skill-rewire gates any further PB dispatch. Completed chains (EF queue, AC chain, SR-33..38, marker sweep, W-waves, OOS retriage, DOC remediation): `memory/archive/claude-md-changelog-2026-07.md`.
