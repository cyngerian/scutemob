...
> Last audited: 2026-03-01 (Embalm validated; KeywordAbility::Embalm disc 92; AbilityDefinition::Embalm disc 25; StackObjectKind::EmbalmAbility disc 27; Command::EmbalmCard; abilities.rs handle_embalm_card + get_embalm_cost; resolution.rs token copy (white, no mana cost, Zombie subtype); 12 unit tests in tests/embalm.rs; Sacred Cat card def at defs/sacred_cat.rs; game script stack/129; P4 validated 22->23, total validated 114->115)
