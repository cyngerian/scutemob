...
> Last audited: 2026-03-02 (Blitz validated; KeywordAbility::Blitz disc 96; AbilityDefinition::Blitz{cost} disc 29; StackObjectKind::BlitzSacrificeTrigger disc 32; PendingTriggerKind::BlitzSacrifice; AltCostKind::Blitz; casting.rs blitz alt-cost validation + mutual exclusion (12 alt costs) + get_blitz_cost; resolution.rs ETB haste grant + draw-on-death trigger + BlitzSacrificeTrigger resolution; turn_actions.rs end_step_actions BlitzSacrificeTrigger queue; StackObject::was_blitzed; 9 unit tests in tests/blitz.rs; Riveteers Requisitioner card def at defs/riveteers_requisitioner.rs; game script stack/133; P4 validated 26->27, total validated 118->119)
