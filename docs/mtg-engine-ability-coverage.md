...
> Last audited: 2026-03-01 (Aftermath validated; KeywordAbility::Aftermath disc 91; AbilityDefinition::Aftermath disc 24; casting.rs graveyard-only zone check + alt-cost exclusion + aftermath cost/effect/target retrieval; resolution.rs exile-on-departure; command.rs cast_with_aftermath flag; 12 unit tests in tests/aftermath.rs; Cut // Ribbons card def at defs/cut_ribbons.rs; game script combat/128; P4 validated 21->22, total validated 113->114)
