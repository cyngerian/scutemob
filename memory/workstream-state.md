...
**Next**: **PB-DX2** (OOS-DP5-7 + OOS-DP7-2 — `ChooseDredge` has no pending-state gate; wire-neutral), then **PB-DX3** (2 flips, 0 engine lines). Both independent of PB-DX1 and of M11-local.
