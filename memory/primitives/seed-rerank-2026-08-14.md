...
> hazard.
>
> **↻ 2026-09-05: `PB-DX39` SHIPPED (`scutemob-230`). The next dispatch is `PB-DX53`** (rank 16
> — CR 508.6 raid gate clobbered by re-declaration, `OOS-DX21-1`, re-scoped by its own review to
> `windbrisk_heights` alone). Ranks **1-15 are all shipped**.
>
