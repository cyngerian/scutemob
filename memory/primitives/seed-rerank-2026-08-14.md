...
> hazard.
>
> **↻ 2026-09-04: `PB-DX35` SHIPPED (`scutemob-227`). The next dispatch is `PB-DX36`** (rank 13 —
> `WhenDealsDamage` + the dead `combat_only` arm, `OOS-CARDS2-6`, which has **no registry row —
> file one first**). Ranks **1-12 are all shipped**.
>
