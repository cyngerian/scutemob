...
> hazard.
>
> **↻ 2026-09-03: `PB-DX20b` SHIPPED (`scutemob-222`). The next dispatch is `PB-DX18`** (rank 10 —
> the trust boundary on ungated commands, `OOS-DP2-7` + `-4` + `-8` + `OOS-DX2-4` + `OOS-DX2-1` +
> `OOS-M11-5`). Ranks **1-9 are all shipped**.
>
