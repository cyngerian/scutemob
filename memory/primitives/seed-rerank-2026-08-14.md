...
> hazard.
>
> **↻ 2026-09-03: `PB-DX49` SHIPPED (`scutemob-220`). The next dispatch is `PB-DX50`** (rank 8 —
> the mutate surface: target legality and CR 702.140c timing, `OOS-DX25-1` + `OOS-DX29-2`).
> Ranks **1-7 are all shipped**.
>
