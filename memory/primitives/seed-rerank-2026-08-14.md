...
> hazard.
>
> **↻ 2026-09-04: `PB-DX18` SHIPPED (`scutemob-225`). The next dispatch is `PB-DX51`** (rank 11 —
> CR 508.8 / 506.4, "put onto the battlefield attacking", `OOS-DX21-4` + `OOS-DX21-5` +
> `OOS-DX21-2`). Ranks **1-10 are all shipped**.
>
