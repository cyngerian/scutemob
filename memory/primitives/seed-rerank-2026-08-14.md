...
> hazard.
>
> **↻ 2026-09-04: `PB-DX51` SHIPPED (`scutemob-226`). The next dispatch is `PB-DX35`** (rank 12 —
> modal trigger targets + the inert `optional`, `OOS-DX4-2` + `OOS-DX4-5`). Ranks **1-11 are all
> shipped**.
>
