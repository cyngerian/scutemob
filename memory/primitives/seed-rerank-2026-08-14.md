...
> now here).
>
> **(b) The member list was a FLOOR by one, as usual, and the extra member is a GRANTED ability.**
> The row, the seed and the brief all name three self-family defs; `tandem_lookout` grants
