...
> hazard.
>
> **↻ 2026-09-04: `PB-DX52` SHIPPED (`scutemob-229`). The next dispatch is `PB-DX39`** (rank 15
> — source-relative filters through LKI, `OOS-DX5-3` + `OOS-DX5-7`'s residual; standing from v3
> rank 33). Ranks **1-14 are all shipped**.
>
