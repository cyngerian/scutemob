...
> hazard.
>
> **↻ 2026-09-02: `PB-DX47` SHIPPED (`scutemob-218`). The next dispatch is `PB-DX48`** (rank 6 —
> Ward never fires on a triggered ability, `OOS-ENG2-1` ≡ `OOS-ENG2-2` + `OOS-ENG2-3`).
> Ranks **1-5 are all shipped**.
> *(prior: `PB-DX45` SHIPPED `scutemob-217` 2026-09-02; `PB-DX15a` SHIPPED `scutemob-216`
> 2026-08-23; `PB-DX44` SHIPPED `scutemob-215` 2026-08-15; `PB-DX43` SHIPPED `scutemob-213`
> 2026-08-14.)*
>
