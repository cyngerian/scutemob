...
> hazard.
>
> **↻ 2026-09-02: `PB-DX48` SHIPPED (`scutemob-219`). The next dispatch is `PB-DX49`** (rank 7 —
> every Saga site reads the printed def, so a blanked Saga is still sacrificed, `OOS-RR4-1` +
