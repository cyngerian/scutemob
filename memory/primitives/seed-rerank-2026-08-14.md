...
> hazard.
>
> **↻ 2026-08-23: `PB-DX15a` SHIPPED (`scutemob-216`). The next dispatch is `PB-DX45`** (rank 4 —
> `Effect::MayPayThenEffect` is pay-when-able, so CR 118.12's player decision is engine-made;
> `OOS-DX24-9` ≡ `OOS-DX27-5`, 11 deck-legal `Complete` defs). Ranks **1-3 are all shipped**.
> *(prior: `PB-DX44` SHIPPED `scutemob-215` 2026-08-15, which made `PB-DX15a` rank 3 the next
> dispatch; `PB-DX43` SHIPPED `scutemob-213` 2026-08-14 before that.)*
>
